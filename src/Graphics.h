...
struct Graphics
{
	...
	static void DrawCircle(const Vec2& pos, int radius, float angle, const Color& color);
	static void DrawFillCircle(const Vec2& pos, int radius, const Color& color);
	...
	static void DrawTexture(const Vec2& pos, int width, int height, float rotation, Texture2D* texture);
};